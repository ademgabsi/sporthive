...
final class AssuranceController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Gestion_Assurances/front/new.html.twig', [
            'assurance' => $assurance,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Assurance $assurance, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Gestion_Assurances/front/edit.html.twig', [
            'assurance' => $assurance,
            'form' => $form,
        ]);
    }

    #[Route('/{ID_contrat}', name: 'app_assurance_delete', methods: ['POST'])]
    public function delete(Request $request, Assurance $assurance, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$assurance->getID_contrat(), $request->request->get('_token'))) {
