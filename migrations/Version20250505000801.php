 ...
 */
final class Version20250505000801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD is_paid TINYINT(1) DEFAULT 0 NOT NULL, CHANGE user_id utilisateur_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT FK_386829AEFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateurs (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_386829AEFB88E14F ON assurance (utilisateur_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE user_id user_id INT NOT NULL, CHANGE Description Description LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT FK_CE60640460349993 FOREIGN KEY (contrat) REFERENCES assurance (ID_contrat) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT FK_CE606404A76ED395 FOREIGN KEY (user_id) REFERENCES utilisateurs (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_reclamation_assurance ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_CE60640460349993 ON reclamation (contrat)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_reclamation_user ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_CE606404A76ED395 ON reclamation (user_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT fk_reclamation_assurance FOREIGN KEY (contrat) REFERENCES assurance (ID_contrat) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT fk_reclamation_user FOREIGN KEY (user_id) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateurs CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE numero_tel numero_tel VARCHAR(255) NOT NULL, CHANGE is_active is_active TINYINT(1) NOT NULL, CHANGE is_two_factor_enabled is_two_factor_enabled TINYINT(1) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP FOREIGN KEY FK_386829AEFB88E14F
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_386829AEFB88E14F ON assurance
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP is_paid, CHANGE utilisateur_id user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation DROP FOREIGN KEY FK_CE60640460349993
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE user_id user_id INT DEFAULT NULL, CHANGE Description Description TEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT fk_reclamation_assurance FOREIGN KEY (contrat) REFERENCES assurance (ID_contrat) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_ce60640460349993 ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_reclamation_assurance ON reclamation (contrat)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_ce606404a76ed395 ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_reclamation_user ON reclamation (user_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT FK_CE60640460349993 FOREIGN KEY (contrat) REFERENCES assurance (ID_contrat) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateurs CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE numero_tel numero_tel VARCHAR(20) NOT NULL, CHANGE is_active is_active TINYINT(1) DEFAULT 1 NOT NULL, CHANGE is_two_factor_enabled is_two_factor_enabled TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
