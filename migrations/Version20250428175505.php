 ...
 */
final class Version20250428175505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance CHANGE user_id user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE Description Description LONGTEXT DEFAULT NULL, CHANGE Montant_reclame montant_reclame INT DEFAULT NULL, CHANGE Montant_rembourse montant_rembourse INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateurs ADD reset_token VARCHAR(255) DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE prenom prenom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE numero_tel numero_tel VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance CHANGE user_id user_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE Description Description TEXT DEFAULT NULL, CHANGE montant_reclame Montant_reclame NUMERIC(10, 2) DEFAULT NULL, CHANGE montant_rembourse Montant_rembourse NUMERIC(10, 2) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT fk_reclamation_assurance FOREIGN KEY (ID_contrat) REFERENCES assurance (ID_contrat) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateurs DROP reset_token, CHANGE nom nom VARCHAR(50) NOT NULL, CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE numero_tel numero_tel VARCHAR(20) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
