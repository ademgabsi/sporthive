 ...
 */
final class Version20250414171423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE competition CHANGE Nom nom VARCHAR(255) DEFAULT NULL, CHANGE Type type VARCHAR(255) DEFAULT NULL, CHANGE Description description LONGTEXT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE Description Description LONGTEXT DEFAULT NULL, CHANGE Montant_reclame montant_reclame INT DEFAULT NULL, CHANGE Montant_rembourse montant_rembourse INT DEFAULT NULL, CHANGE ID_contrat contrat INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE Description Description TEXT DEFAULT NULL, CHANGE montant_reclame Montant_reclame NUMERIC(10, 2) DEFAULT NULL, CHANGE montant_rembourse Montant_rembourse NUMERIC(10, 2) DEFAULT NULL, CHANGE contrat ID_contrat INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
