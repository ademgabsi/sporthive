 ...
 */
final class Version20250413130246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP FOREIGN KEY fk_client_assurance
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance DROP FOREIGN KEY fk_client_assurance
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD type_de_couverture VARCHAR(255) NOT NULL, ADD date_debut VARCHAR(255) NOT NULL, DROP typeDeCouverture, DROP dateDebut, CHANGE user_id user_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT FK_386829AEA76ED395 FOREIGN KEY (user_id) REFERENCES utilisateurs (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_client_assurance ON assurance
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_386829AEA76ED395 ON assurance (user_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT fk_client_assurance FOREIGN KEY (user_id) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition DROP FOREIGN KEY fk_competition_user
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition DROP FOREIGN KEY fk_competition_user
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition CHANGE id_user id_user INT DEFAULT NULL, CHANGE Nom nom VARCHAR(255) DEFAULT NULL, CHANGE Type type VARCHAR(255) DEFAULT NULL, CHANGE Description description LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition ADD CONSTRAINT FK_B50A2CB16B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateurs (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_competition_user ON competition
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_B50A2CB16B3CA4B ON competition (id_user)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition ADD CONSTRAINT fk_competition_user FOREIGN KEY (id_user) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE equipe DROP FOREIGN KEY fk_equipe_user
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE equipe DROP FOREIGN KEY fk_equipe_user
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE equipe CHANGE id_user id_user INT DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE equipe ADD CONSTRAINT fk_equipe_user FOREIGN KEY (id_user) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE gestion_match CHANGE id_user id_user INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE Description description LONGTEXT DEFAULT NULL, CHANGE Etat etat VARCHAR(255) DEFAULT NULL, CHANGE Montant_reclame montant_reclame NUMERIC(10, 0) DEFAULT NULL, CHANGE Montant_rembourse montant_rembourse NUMERIC(10, 0) DEFAULT NULL, CHANGE ID_contrat ID_contrat INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE sponsor ADD date_debut DATE NOT NULL, ADD date_fin DATE NOT NULL, DROP dateDebut, DROP dateFin, CHANGE idMatch idMatch INT DEFAULT NULL, CHANGE montantContrat montant_contrat INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD typeDeCouverture VARCHAR(255) NOT NULL, ADD dateDebut VARCHAR(255) NOT NULL, DROP type_de_couverture, DROP date_debut, CHANGE user_id user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT fk_client_assurance FOREIGN KEY (user_id) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_386829aea76ed395 ON assurance
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_client_assurance ON assurance (user_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE assurance ADD CONSTRAINT FK_386829AEA76ED395 FOREIGN KEY (user_id) REFERENCES utilisateurs (id)
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition CHANGE id_user id_user INT NOT NULL, CHANGE nom Nom VARCHAR(100) DEFAULT NULL, CHANGE type Type VARCHAR(50) DEFAULT NULL, CHANGE description Description TEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition ADD CONSTRAINT fk_competition_user FOREIGN KEY (id_user) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_b50a2cb16b3ca4b ON competition
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_competition_user ON competition (id_user)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE competition ADD CONSTRAINT FK_B50A2CB16B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateurs (id)
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE gestion_match CHANGE id_user id_user INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE gestion_match ADD CONSTRAINT fk_match_user FOREIGN KEY (id_user) REFERENCES utilisateurs (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE description Description TEXT DEFAULT NULL, CHANGE etat Etat VARCHAR(50) DEFAULT NULL, CHANGE montant_reclame Montant_reclame NUMERIC(10, 2) DEFAULT NULL, CHANGE montant_rembourse Montant_rembourse NUMERIC(10, 2) DEFAULT NULL, CHANGE ID_contrat ID_contrat INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT fk_reclamation_assurance FOREIGN KEY (ID_contrat) REFERENCES assurance (ID_contrat) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE sponsor ADD dateDebut DATE NOT NULL, ADD dateFin DATE NOT NULL, DROP date_debut, DROP date_fin, CHANGE idMatch idMatch INT NOT NULL, CHANGE montant_contrat montantContrat INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE sponsor ADD CONSTRAINT fk_client_match FOREIGN KEY (idMatch) REFERENCES gestion_match (id) ON UPDATE CASCADE ON DELETE CASCADE
        SQL);
